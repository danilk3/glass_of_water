...
abstract class AppTextStyle {
  static final inputLabelStyle =
      GoogleFonts.roboto(fontSize: 20, color: const Color(0xFF212529));

  static final boldTextStyle = GoogleFonts.roboto(
      fontSize: 16,
      fontWeight: FontWeight.bold,
      color: const Color(0xFF212529));

  static final profileInfoStyle =
      GoogleFonts.roboto(fontSize: 16, color: const Color(0xFF212529));

  static final profileOptionsStyle =
      GoogleFonts.roboto(fontSize: 20, color: const Color(0xFF212529));

  static final profileOptionsBoldStyle = GoogleFonts.roboto(
      fontSize: 20,
